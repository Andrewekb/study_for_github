...
-- в задании нужно вывести maker, сделал таким образом, логика следующая: по производителю внутри типа процентное соотношение моделей, какая доля у производителя конкретного
...
-- для графика немного скорректирую, диаграмма будет только по типу
